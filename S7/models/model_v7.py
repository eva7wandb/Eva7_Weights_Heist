...
class Net(nn.Module):
    def __init__(
        ...
        self.trans2 = transition_block(n_in=64, n_mid=64, n_out=64, stride=2, padding=2,)

        # CONVOLUTION BLOCK 3
        self.convblock3 = conv_block(n_in=64, n_mid=32, n_out=64, padding=1,)
        self.convblock3_2 = dilated_conv_block(n_in=64, n_mid=32, n_out=64, padding=2,)

        # TRANSITION BLOCK 3
        self.trans3 = transition_block(n_in=64, n_mid=32, n_out=32, stride=2, padding=1,) 

        # CONVOLUTION BLOCK 4
        self.convblock4 = conv_block(n_in=32, n_mid=32, n_out=32, padding=1,)
